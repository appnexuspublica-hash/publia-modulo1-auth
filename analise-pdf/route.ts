...
function buildPrompt(params: {
  ...
  return [
    ...
    "- Você está no chat individual do Publ.IA Essencial ou Publ.IA Estratégico.",
...
export async function POST(req: Request) {
  ...
  const productTier: IndividualProductTier = normalizedTier;
    ...
    const stream = new ReadableStream({
      async start(controller) {
        ...
        try {
          ...
          console.error("[/api/chat] erro no stream:", error);
