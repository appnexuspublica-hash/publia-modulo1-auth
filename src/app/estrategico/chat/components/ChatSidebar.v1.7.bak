//src/app/estrategico/chat/components/ChatSidebar.tsx
"use client";
...
export function ChatSidebar({
  ...
  const strategicSidebarBg = "#EFEFEF";
  const strategicSidebarHover = "#E5E5E5";
  const strategicSidebarActive = "#DCDCDC";
  ...
  return (
    <aside
      ...
      style={{
        ...
        borderColor: isStrategic ? "rgba(13,43,77,0.2)" : theme.colors.border,
        color: isStrategic ? strategicHeaderText : theme.colors.text,
      }}
    >
      <div
        className="border-b px-4 pt-4 pb-4"
        style={{
            ...
            <div className="flex min-w-0 flex-1 flex-col">
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-full bg-[#F5A623] px-3 py-1 text-[10px] font-semibold leading-none text-[#0D2B4D] shadow-sm transition hover:brightness-105"
                >
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden px-4 pb-4">
        <div className="mb-4 pt-6">
              ...
              <form onSubmit={handleSearchSubmit} className="mb-4">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-full rounded-xl border px-3 py-2 text-[12px] outline-none placeholder:text-[#5A5A5A]/70"
                    style={{
                      backgroundColor: strategicSearchBg,
                      borderColor: strategicSearchBorder,
                      color: strategicHeaderText,
                    }}
                  />

                  <button
                    type="submit"
                    className="rounded-xl border px-3 py-2 text-[11px] font-semibold text-[#0D2B4D] transition"
                    style={{
                      backgroundColor: strategicSidebarBg,
                      borderColor: strategicSearchBorder,
                    }}
          ...
          <div
            ...
            style={{ color: isStrategic ? strategicHeaderText : "#334155" }}
          >
            HISTÓRICO
          </div>
        </div>
        ...
        <div ref={menuContainerRef} className="space-y-1 pr-1">
          {filteredAndSortedConversations.length === 0 && (
            <div
              className="text-[12px]"
              style={{ color: isStrategic ? strategicHeaderMuted : "#64748b" }}
            >
              {searchTerm.trim()
                  ...
                  style={{
                    ...
                    color: isStrategic
                      ...
                      : isActive
                        ...
                        : "#334155",
                    border: isStrategic
                      ? `1px solid ${isActive ? strategicSearchBorder : "transparent"}`
                          ...
                          {isMenuOpen && (
                            ...
                            >
                              <button
                                ...
                                className="block w-full px-3 py-2 text-left text-[11px] font-medium text-[#0D2B4D] transition disabled:cursor-not-allowed disabled:opacity-60"
                                onMouseEnter={(e) => {
                              ...
                              <button
                                ...
                                className="block w-full px-3 py-2 text-left text-[11px] font-medium text-red-600 transition"
                                onMouseEnter={(e) => {
                                  e.currentTarget.style.backgroundColor =
                                    "rgba(239,68,68,0.18)";
                                }}
      ...
      <div
        ...
        style={{
          borderColor: isStrategic ? "rgba(13,43,77,0.10)" : "#e2e8f0",
