...
check(
  GOVERNANCE_RESULT_SNAPSHOT_VERSION === "15.17",
  "persistência v15.16: contrato versionado em 15.16",
);
check(
  GOVERNANCE_PIPELINE_VERSION === "governance-v15.17-idempotency-before-external-work",
...
check(GOVERNANCE_CORE_VERSION === "15.17", "versão central do core é 15.16");
check(
...
check(
  GOVERNANCE_CORE_VERSION === "15.17" &&
    GOVERNANCE_PIPELINE_VERSION ===
      "governance-v15.17-idempotency-before-external-work" &&
    GOVERNANCE_RESULT_SNAPSHOT_VERSION === "15.17",
  "versionamento v15.17: core, pipeline e snapshot estão alinhados",
);

console.log(`\nGovernança v15.17: ${checks - failures}/${checks} verificações aprovadas.`);
