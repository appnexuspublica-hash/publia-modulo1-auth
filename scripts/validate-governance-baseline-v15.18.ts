...
check(GOVERNANCE_CORE_VERSION === "15.18", "versão central do core é 15.18");
check(
...
check(
  GOVERNANCE_CORE_VERSION === "15.18" &&
    GOVERNANCE_PIPELINE_VERSION ===
      "governance-v15.18-recoverable-processing-lease" &&
    GOVERNANCE_RESULT_SNAPSHOT_VERSION === "15.18",
  "versionamento v15.18: core, pipeline e snapshot estão alinhados",
);

console.log(`\nGovernança v15.18: ${checks - failures}/${checks} verificações aprovadas.`);
